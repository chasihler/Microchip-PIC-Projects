...
#define PROGRAM_MEM_START_ADDRESS		0x001200 //Beginning of application program memory (not occupied by bootloader).  **THIS VALUE MUST BE ALIGNED WITH 64 BYTE BLOCK BOUNDRY** Also, in order to work correctly, make sure the StartPageToErase is set to erase this section.
	...
	#define MaxPageToErase				507		 //Last 64 byte page of flash on the PIC18F4550
