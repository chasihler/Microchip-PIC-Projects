...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/i2c_digital_resistor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/i2c_digital_resistor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
