 ...
 *
 *  Notes
 *  We will ignore the Num of Reg Hi Byte (no queries over 255 or unreliable results)
...
#define _XTAL_FREQ 8000000 //defined for delay
    ...
    int frame, z, bufferbits, query_reg_address;
    char data_out[64];
...
void init_io(void) {
    ...
    TRISAbits.TRISA0 = 1; // multiplex input 1
    TRISAbits.TRISA1 = 1; // multiplex input 2
    TRISAbits.TRISA2 = 1; // multiplex input 3
    TRISAbits.TRISA3 = 0; // output
    TRISAbits.TRISA4 = 0; // bank select
    TRISAbits.TRISA5 = 0; // latch output
