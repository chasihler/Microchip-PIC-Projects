...
//Uncomment below if using the YOUR_BOARD hardware platform
   ...
   // #define PICDEM_FS_USB_K50
    ...
    #define DEMO_BOARD LF25K50
    #define CLOCK_FREQ 48000000


    /** LED ************************************************************/
    #define mInitAllLEDs()      LATA &= 0xED; LATB &= 0x3F; TRISA &= 0xED; TRISB &= 0x3F;
    ...
    /** SWITCH *********************************************************/
    #define mInitAllSwitches()  TRISAbits.TRISA3=1;
    #define mInitSwitch2()      TRISAbits.TRISA3=1;
    #define mInitSwitch3()      TRISAbits.TRISA3=1;
    #define sw2                 PORTAbits.RA3
    #define sw3                 PORTAbits.RA3
...
#if defined(PIC18F4550_PICDEM_FS_USB_K50) || defined(LF25K50_DEMO)
