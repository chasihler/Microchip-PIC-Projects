...
Project is built and tested with MPLAB 8.92 or MPLABX 1.95 and PIC18 C Compiler 3.44. It is highly recommended to use the exact same compiler. Adapting the code for other compilers (for instance XC8) may be possible but Olimex provides no support for the example for compilers or IDEs different than the ones suggested.
